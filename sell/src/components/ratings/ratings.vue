  ...
  <div class="ratings" ref="ratings">
    <div class="ratings-content">
      ...
      <div class="rating-wrapper">
        <ul>
          <li v-show="needShow(rating.rateType, rating.text)" v-for="rating in ratings" class="rating-item border-1px" :key="rating.username">
            <div class="avatar">
            ...
            <div class="content">
              ...
              <div class="recommend" v-show="rating.recommend && rating.recommend.length">
                <img src="./good.png" height="12px" width="12px">
